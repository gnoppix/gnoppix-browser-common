...
var gGnoppixPane = {
  ...
  init() {
    this._pane = document.getElementById("paneGnoppix");

    // Set all event listeners on checkboxes
    setBoolSyncListeners(
      "gnoppix-browser-extension-update-checkbox",
      ["extensions.update.autoUpdateDefault", "extensions.update.enabled"],
      [true,                                  true                       ],
    );
    setBoolSyncListeners(
      "gnoppix-browser-ipv6-checkbox",
      ["network.dns.disableIPv6"],
      [false,                   ],
    );
    setBoolSyncListeners(
      "gnoppix-browser-ocsp-checkbox",
      ["security.OCSP.require"],
      [true,                   ],
    );
    setBoolSyncListeners(
      "gnoppix-browser-sync-checkbox",
      ["identity.fxaccounts.enabled"],
      [true,                   ],
    );
    setBoolSyncListeners(
      "gnoppix-browser-autocopy-checkbox",
      ["clipboard.autocopy", "middlemouse.paste"],
      [true,                 true               ],
    );
    setBoolSyncListeners(
      "gnoppix-browser-styling-checkbox",
      ["toolkit.legacyUserProfileCustomizations.stylesheets"],
      [true,                                                ],
    );

    setBoolSyncListeners(
      "gnoppix-browser-webgl-checkbox",
      ["webgl.disabled"],
      [false           ],
    );
    setBoolSyncListeners(
      "gnoppix-browser-rfp-checkbox",
      ["privacy.resistFingerprinting"],
      [true                          ],
    );
    setBoolSyncListeners(
      "gnoppix-browser-auto-decline-canvas-checkbox",
      ["privacy.resistFingerprinting.autoDeclineNoUserInputCanvasPrompts"],
      [true                                      ],
    );

    setBoolSyncListeners(
      "gnoppix-browser-letterboxing-checkbox",
      ["privacy.resistFingerprinting.letterboxing"],
      [true                                       ],
    );

    setSyncListeners(
      "gnoppix-browser-goog-safe-checkbox",
      [
    ...
    setXOriginPolicySyncListeners(
      "gnoppix-browser-xorigin-ref-checkbox",
    ...
    setEventListener("gnoppix-browser-open-profile", "command", openProfileDirectory);
    // Set event listener on open about:config button
    setEventListener("gnoppix-browser-config-link", "click", openAboutConfig);

    // Notify observers that the UI is now ready
    Services.obs.notifyObservers(window, "gnoppix-browser-pane-loaded");
  },
};
